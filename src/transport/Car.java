...
public class Car extends Transport {
    ...
    public Car(String brand, String model, double engineVolume, String color,
               String year, String country, String transmission, String bodyStyle,
               String registrationNumber, int numberOfSeats, String typeOfTire, int maxSpeed) {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(car.engineVolume, engineVolume) == 0 && year == car.year &&
                numberOfSeats == car.numberOfSeats && brand.equals(car.brand) && model.equals(car.model) &&
                color.equals(car.color) && country.equals(car.country) && transmission.equals(car.transmission) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(brand, model, engineVolume, color, year, country, transmission,
                bodyStyle, registrationNumber, numberOfSeats, typeOfTire);
    }
